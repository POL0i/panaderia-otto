            ...
            <div class="p-3 border-bottom recibo-header">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        ...
                        <h6><span class="badge badge-success">#<?php echo e($notaVenta->id_nota_venta); ?></span></h6>
                        <small>Fecha: <?php echo e($notaVenta->fecha_venta ? $notaVenta->fecha_venta->format('d/m/Y') : 'Sin fecha'); ?></small>
                    </div>
                </div>
            </div>
            ...
            <div class="p-3 border-bottom">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        ...
                        <small>Método: <?php echo e($notaVenta->metodo_pago ?? 'N/A'); ?></small>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-right"><strong>Bs. <?php echo e(number_format($notaVenta->monto_total ?? 0, 2)); ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/panaderia-otto/resources/views/notas-venta/show.blade.php ENDPATH**/ ?>