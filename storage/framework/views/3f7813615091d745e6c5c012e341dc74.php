...
<div class="container-fluid">
    ...
    <div class="card shadow-sm animate-fade-in-up">
        ...
        <form action="<?php echo e(route('proveedores.update', $proveedor->id_proveedor)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="tipo_proveedor" name="tipo_proveedor" required onchange="toggleFields()">
                        <option value="persona" <?php echo e(old('tipo_proveedor', $proveedor->tipo_proveedor) === 'persona' ? 'selected' : ''); ?>>Persona</option>
                        <option value="empresa" <?php echo e(old('tipo_proveedor', $proveedor->tipo_proveedor) === 'empresa' ? 'selected' : ''); ?>>Empresa</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>" id="nombre" name="nombre" value="<?php echo e(old('nombre', $proveedor->persona?->nombre ?? '')); ?>" placeholder="Nombre del proveedor">
...
unset($__errorArgs, $__bag); ?>" id="razon_social" name="razon_social" value="<?php echo e(old('razon_social', $proveedor->empresa?->razon_social ?? '')); ?>" placeholder="Razón social de la empresa">
...
unset($__errorArgs, $__bag); ?>" id="correo" name="correo" value="<?php echo e(old('correo', $proveedor->correo)); ?>" placeholder="ejemplo@email.com" required>
...
unset($__errorArgs, $__bag); ?>" id="telefono" name="telefono" value="<?php echo e(old('telefono', $proveedor->telefono)); ?>" placeholder="+56 9 1234 5678" required>
...
unset($__errorArgs, $__bag); ?>" id="direccion" name="direccion" value="<?php echo e(old('direccion', $proveedor->direccion)); ?>" placeholder="Calle, número, ciudad" required>
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/panaderia-otto/resources/views/proveedores/edit.blade.php ENDPATH**/ ?>