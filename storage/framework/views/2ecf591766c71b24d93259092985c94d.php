...
<div class="container-fluid">
    <div class="row mb-3 animate-fade-in-up">
        ...
        <div class="col-md-6 text-right">
            <a href="<?php echo e(route('clientes.index')); ?>" class="btn btn-back btn-sm">
...
unset($__errorArgs, $__bag); ?>" id="nombre" name="nombre" value="<?php echo e(old('nombre')); ?>" placeholder="Nombre del cliente" required>
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panaderia-otto\resources\views/clientes/create.blade.php ENDPATH**/ ?>