    ...
    <div class="content">
        <div class="info-row">
            <div>
                ...
                <span class="badge"><?php echo e(str_pad($nota->id_nota_venta, 6, '0', STR_PAD_LEFT)); ?></span>
            </div>
            <div>
                <strong>Fecha:</strong> <?php echo e(\Carbon\Carbon::parse($nota->fecha_venta)->format('d/m/Y H:i')); ?>
        ...
        <div class="info-row">
            <div>
                ...
                <?php echo e($nota->cliente->nombre ?? 'N/A'); ?><br>
                <small>Tel: <?php echo e($nota->cliente->telefono ?? 'N/A'); ?></small>
            </div>
            <div>
                <strong>Atendido por:</strong><br>
                <?php echo e($nota->empleado->nombre ?? 'N/A'); ?><br>
                <small>ID: <?php echo e($nota->empleado->id_empleado ?? '1'); ?></small>
            </div>
        </div>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $nota->detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($detalle->item->producto->nombre ?? 'Producto'); ?></td>
                        <td><?php echo e($detalle->almacen->nombre ?? 'N/A'); ?></td>
                        <td class="text-right">Bs. <?php echo e(number_format($detalle->precio, 2)); ?></td>
                        <td class="text-right">Bs. <?php echo e(number_format($subtotal, 2)); ?></td>
                    </tr>
        ...
        <div class="total">
            Total: Bs. <?php echo e(number_format($nota->monto_total, 2)); ?>
...
</html><?php /**PATH /opt/lampp/htdocs/panaderia-otto/resources/views/emails/comprobante-venta.blade.php ENDPATH**/ ?>