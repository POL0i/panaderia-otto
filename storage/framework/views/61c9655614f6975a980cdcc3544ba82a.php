            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item mx-2">
                        <form action="<?php echo e(route('buscar')); ?>" method="GET" class="d-flex">
                            <div class="input-group input-group-sm" style="width: 180px;">
                                <input type="text" name="q" class="form-control" 
                                       placeholder="Buscar..." value="<?php echo e(request('q')); ?>" 
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="text-center pt-3 mt-3 border-top border-secondary">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Panadería Otto</p>
                <span class="page-visit-counter">
                    <i class="fas fa-eye"></i> <?php echo e($pageVisitCount ?? 0); ?> visitas
                </span>
            </div>
        </div>
    </footer>
