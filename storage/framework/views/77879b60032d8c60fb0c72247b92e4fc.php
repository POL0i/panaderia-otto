                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong><?php echo e($producto->item->nombre ?? 'N/A'); ?></strong>
                                            <br>
                                        </td>
                                        <td>
                                            <span class="badge badge-primary"><?php echo e($producto->categoria->nombre ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-secondary"><?php echo e($producto->item->unidad_medida ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-success">$<?php echo e(number_format($producto->precio, 2)); ?></span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('productos.edit', $producto->id_producto)); ?>" class="btn btn-warning" title="Editar">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info"><?php echo e($categoria->productos->count()); ?></span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/panaderia-otto/resources/views/producto/index.blade.php ENDPATH**/ ?>