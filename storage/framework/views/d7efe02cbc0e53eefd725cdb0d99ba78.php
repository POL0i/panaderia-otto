...
<body>
    <div class="payment-card">
        ...
        <p style="color: #666; margin: 20px 0;">
            Monto a pagar: <strong style="color: #8B4513; font-size: 24px;">Bs. <?php echo e(number_format($notaVenta->monto_total, 2)); ?></strong>
        </p>
    ...
    <script>
        const urlPasarela = "<?php echo e($url_pasarela); ?>";
        ...
        if (urlPasarela) {
            ...
            document.querySelector('.payment-card').innerHTML = '<div class="alert alert-danger">Error: No se pudo generar el enlace de pago. <a href="<?php echo e(route("landing")); ?>">Volver a la tienda</a></div>';
        }
    </script>
</body>
</html><?php /**PATH C:\xampp\htdocs\panaderia-otto\resources\views/pago/mostrar.blade.php ENDPATH**/ ?>