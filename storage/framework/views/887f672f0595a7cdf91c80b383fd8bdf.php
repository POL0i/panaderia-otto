...
<div class="modal fade" id="createEmpleadoModal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content border-panaderia">
            ...
            <form id="formCrearEmpleado" action="<?php echo e(route('empleados.store-ajax')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /opt/lampp/htdocs/panaderia-otto/resources/views/usuarios/partials/modal-create-empleado.blade.php ENDPATH**/ ?>