...
<div class="payment-card">
    ...
    <div class="order-info">
        <span class="order-number"><i class="fas fa-receipt"></i> Pedido #{{ $notaVenta->id_nota_venta }}</span>
        <span class="order-total">Bs. {{ number_format($notaVenta->monto_total, 2) }}</span>
    </div>
    ...
    <div class="payment-body">
        ...
        <a href="{{ route('mis-pedidos') }}" class="btn-outline">
...
<script>
    ...
    function verificarPago() {
        verificaciones++;
        $.get('/pago/verificar/{{ $notaVenta->id_nota_venta }}')
            .done(function(response) {
                if (response.pagado) {
                    window.location.href = '{{ route("pago.exito", $notaVenta->id_nota_venta) }}';
