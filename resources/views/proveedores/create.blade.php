            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control @error('tipo_proveedor') is-invalid @enderror" id="tipo_proveedor" name="tipo_proveedor" required onchange="toggleFields()">
                        ...
                        <option value="persona" {{ old('tipo_proveedor') === 'persona' ? 'selected' : '' }}>Persona</option>
                        <option value="empresa" {{ old('tipo_proveedor') === 'empresa' ? 'selected' : '' }}>Empresa</option>
                    </select>
                ...
                <div class="form-group" id="razon_social_field" style="display: none;">
                    ...
                    <input type="text" class="form-control @error('razon_social') is-invalid @enderror" id="razon_social" name="razon_social" value="{{ old('razon_social') }}" placeholder="Razón social de la empresa">
                    @error('razon_social')
                        <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" value="{{ old('correo') }}" placeholder="ejemplo@email.com" required>
                    @error('correo')
                        <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" placeholder="+56 9 1234 5678" required>
                    @error('telefono')
                        <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{ old('direccion') }}" placeholder="Calle, número, ciudad" required>
                    @error('direccion')
                        <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
