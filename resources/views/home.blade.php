...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('home') }}" style="color: #8B4513;">Inicio</a></li>
        ...
        <div class="col-12">
            <div class="alert" style="background: linear-gradient(135deg, #FFF5E6 0%, #FFF9F0 100%); border-left: 4px solid #8B4513; border-radius: 12px;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0" style="color: #5D3A1A;">¡Bienvenido de vuelta, {{ Auth::user()->name ?? 'Administrador' }}!</h5>
                        <small style="color: #A0522D;">Hoy es {{ \Carbon\Carbon::now()->locale('es')->isoFormat('dddd D [de] MMMM [de] YYYY') }}</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box" style="background: linear-gradient(135deg, #8B4513 0%, #6B4226 100%); border-radius: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.2s ease;">
                <div class="inner">
                    <h3 style="color: white; font-weight: 700;">{{ $totalProductos ?? '150' }}</h3>
                ...
                <a href="{{ route('productos.index') }}" class="small-box-footer" style="background: rgba(0,0,0,0.1); color: white; border-radius: 0 0 16px 16px; padding: 10px;">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box" style="background: linear-gradient(135deg, #D2B48C 0%, #C4A67A 100%); border-radius: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.2s ease;">
                <div class="inner">
                    <h3 style="color: #5D3A1A; font-weight: 700;">{{ $ventasHoy ?? '53' }}</h3>
                ...
                <a href="{{ route('notas-venta.index') }}" class="small-box-footer" style="background: rgba(93,58,26,0.1); color: #5D3A1A; border-radius: 0 0 16px 16px; padding: 10px;">
                    Ver detalles <i class="fas fa-arrow-circle-right ml-1"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box" style="background: linear-gradient(135deg, #A0522D 0%, #8B4513 100%); border-radius: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.2s ease;">
                <div class="inner">
                    <h3 style="color: white; font-weight: 700;">{{ $totalClientes ?? '44' }}</h3>
                ...
                <a href="{{ route('clientes.index') }}" class="small-box-footer" style="background: rgba(0,0,0,0.1); color: white; border-radius: 0 0 16px 16px; padding: 10px;">
                    Ver detalles <i class="fas fa-arrow-circle-right ml-1"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box" style="background: linear-gradient(135deg, #D2691E 0%, #B85C1A 100%); border-radius: 16px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.2s ease;">
                <div class="inner">
                    <h3 style="color: white; font-weight: 700;">{{ $pedidosPendientes ?? '65' }}</h3>
