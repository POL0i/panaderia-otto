...
<div class="container-fluid">
    <div class="row mb-3 animate-fade-in-up">
        <div class="col-md-6">
            <h1 class="h3 mb-0"><i class="fas fa-pencil-alt icon-panaderia"></i> Editar Movimiento #{{ $movimiento->id_movimiento }}</h1>
        </div>
            ...
            <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="tipo_movimiento" id="tipo_movimiento" class="form-control @error('tipo_movimiento') is-invalid @enderror">
                            ...
                            @foreach($tipos_movimiento as $tipo)
                                <option value="{{ $tipo }}" {{ old('tipo_movimiento', $movimiento->tipo_movimiento) == $tipo ? 'selected' : '' }}>
                                    {{ ucfirst($tipo) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="id_almacen" id="id_almacen" class="form-control @error('id_almacen') is-invalid @enderror">
                            ...
                            @foreach($almacenes as $almacen)
                                <option value="{{ $almacen->id_almacen }}" {{ old('id_almacen', $movimiento->id_almacen) == $almacen->id_almacen ? 'selected' : '' }}>
                                    {{ $almacen->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="id_item" id="id_item" class="form-control @error('id_item') is-invalid @enderror">
                            ...
                            @foreach($items as $item)
                                <option value="{{ $item->id_item }}" {{ old('id_item', $movimiento->id_item) == $item->id_item ? 'selected' : '' }}>
                                    {{ $item->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="cantidad" id="cantidad" step="0.01" class="form-control @error('cantidad') is-invalid @enderror" value="{{ old('cantidad', $movimiento->cantidad) }}" placeholder="0.00">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="precio_unitario" id="precio_unitario" step="0.01" class="form-control @error('precio_unitario') is-invalid @enderror" value="{{ old('precio_unitario', $movimiento->precio_unitario) }}" placeholder="0.00">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="referencia_tipo" id="referencia_tipo" class="form-control @error('referencia_tipo') is-invalid @enderror">
                            ...
                            @foreach($referencias_tipo as $ref)
                                <option value="{{ $ref }}" {{ old('referencia_tipo', $movimiento->referencia_tipo) == $ref ? 'selected' : '' }}>
                                    {{ ucfirst($ref) }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="referencia_id" id="referencia_id" class="form-control @error('referencia_id') is-invalid @enderror" value="{{ old('referencia_id', $movimiento->referencia_id) }}" placeholder="Ej: 123">
                ...
                <div class="form-group">
                    ...
                    <textarea name="observaciones" id="observaciones" class="form-control @error('observaciones') is-invalid @enderror" rows="3" placeholder="Notas adicionales...">{{ old('observaciones', $movimiento->observaciones) }}</textarea>
