...
@section('title', 'Crear Nota de Venta')

@section('content')
<div class="container-fluid">
    <div class="row mb-3 animate-fade-in-up">
        <div class="col-md-6">
            <h1 class="h3 mb-0"><i class="fas fa-file-invoice-dollar icon-panaderia"></i> Crear Nota de Venta</h1>
        </div>
    ...
    <div class="card shadow-sm animate-fade-in-up">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-plus-circle"></i> Formulario de Nota de Venta</h5>
        </div>
        <form action="{{ route('notas-venta.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
