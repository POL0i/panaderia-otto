                ...
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        @forelse($detalles as $detalle)
                            <tr>
                                <td>{{ $detalle->id_detalle_receta }}</td>
                                <td>{{ $detalle->receta->nombre ?? 'N/A' }}</td>
                                <td>{{ $detalle->insumo->nombre ?? 'N/A' }}</td>
                                <td>{{ $detalle->cantidad_requerida }}</td>
                                <td>
                                    <a href="{{ route('detalles-receta.show', $detalle) }}" class="btn btn-info btn-xs" title="Ver">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('detalles-receta.edit', $detalle) }}" class="btn btn-warning btn-xs" title="Editar">
