...
@section('title', 'Crear Producción')

@section('content')
<div class="container-fluid">
    <div class="row mb-3 animate-fade-in-up">
        <div class="col-md-8">
            <h1 class="h3 mb-0"><i class="fas fa-hammer icon-panaderia"></i> Crear Nueva Producción</h1>
        </div>
    ...
    <div class="card shadow-sm animate-fade-in-up">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-edit"></i> Formulario de Producción</h5>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="fecha_produccion" id="fecha_produccion" class="form-control @error('fecha_produccion') is-invalid @enderror" value="{{ old('fecha_produccion', date('Y-m-d')) }}" required>
