...
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card">
                    <div class="product-img" style="background-image: url('{{ $producto->imagen ?? 'https://via.placeholder.com/300x220?text=Pan+Otto' }}');">
                        <span class="product-badge">{{ $producto->categoria ?? 'Destacado' }}</span>
                    </div>
                    <div class="product-body">
                        <h3 class="product-title">{{ $producto->nombre ?? 'Pan Artesanal' }}</h3>
                        <p class="product-desc">{{ Str::limit($producto->descripcion ?? 'Delicioso pan horneado con ingredientes naturales y receta tradicional.', 80) }}</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="product-price">
                                ${{ number_format($producto->precio ?? 0, 2) }} <small>c/u</small>
                            </div>
        ...
        <div class="row mt-4 mb-5">
            <div class="col-md-6">
                <div class="anuncio text-center h-100 d-flex flex-column justify-content-center">
                    ...
                    <p>Pedidos mínimos de $150. Entrega en menos de 1 hora en zona centro.</p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="promo-card">
                            ...
                            <h3 style="color: #8B4513; font-weight: 700;">$45.00</h3>
                            <small class="text-muted">Precio regular: $60</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="promo-card">
                            ...
                            <h3 style="color: #8B4513; font-weight: 700;">-10%</h3>
                            <small class="text-muted">Presenta tu INE</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="promo-card">
    ...
    <!-- Botón flotante de WhatsApp -->
    <a href="https://wa.me/521234567890" class="whatsapp-float" target="_blank">
